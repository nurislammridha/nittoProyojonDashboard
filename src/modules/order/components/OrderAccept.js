...
import { GetOrderList, statusUpdate } from "../_redux/OrderAction";
import OrderDetails from "./OrderDetails";
import { FalseUpdate } from "src/modules/product/_redux/ProductAction";
...
const OrderAccept = () => {
  ...
  //   useEffect(() => {
  //     dispatch(GetOrderList(orderDate,"isCreated"))
  //   }, []);
  useEffect(() => {
    dispatch(GetOrderList(orderDate, "isCreated"));
  }, [orderDate]);
